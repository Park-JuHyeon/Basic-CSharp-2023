...
namespace cs22_collection
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(array[1]);    // IndexOutOfRangeException

            char[] oldstring = new char[5];     //옛날방식 - 문자열 길이를 지정해줘야함 C에서만 사용
            string curString = "";      // 문자열 길이 제한없음
