...
namespace cs20_abstractClass
{
    ...
    {
        public override void MethodC()      // 재정의(사실은 인터페이스 구현) => MethodC는 구현이 안되있으므로 재정의 해줘야함
        {
    ...
    abstract class Mammal   // 포유류 부모클래스
    {
        public void Nurse()
        {
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            parent.MethodC();
            parent.MethodB();
            // parent.MethodA는 안됨 => protected는 자기자신과 자식클래스내에서만 쓸수 있다.
        }
    }
}
