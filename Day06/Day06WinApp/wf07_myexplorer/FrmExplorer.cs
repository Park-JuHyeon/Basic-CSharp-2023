...
using System.Data;
using System.Diagnostics;       // Process 사용시
...
namespace wf07_myexplorer
{
    public partial class FrmExplorer : Form
    {
        ...
        private void FrmExplorer_Load(object sender, EventArgs e)
        {
            ...
            CboView.SelectedIndex = 0;  // View.Details 기본선택
        ...
        private void CboView_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (CboView.SelectedIndex)
            {
                ...
                //default:      // 위와같이 케이스가 5개밖에 없는 경우에는 default 굳이 필요없음!
                //    LsvFolder.View = View.Details; break;
        ...
        {
            if (e.KeyChar == 13)    // Enter키를 누르면, 이라는 뜻
            {
                try
                {
                ...
                {
                    MessageBox.Show("경로를 찾을수 없습니다. 맞춤법을 확인하고 다시 시도하십시요.", "나의 탐색기",
